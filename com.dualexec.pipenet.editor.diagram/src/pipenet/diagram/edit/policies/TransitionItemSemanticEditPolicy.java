...
import pipenet.diagram.edit.commands.ArcCreateCommand;
import pipenet.diagram.edit.commands.ArcReorientCommand;
...
public class TransitionItemSemanticEditPolicy extends
	...
	public TransitionItemSemanticEditPolicy() {
		super(PipenetElementTypes.Transition_2001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (PipenetVisualIDRegistry.getVisualID(incomingLink) == ArcEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (PipenetVisualIDRegistry.getVisualID(outgoingLink) == ArcEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (PipenetElementTypes.Arc_4001 == req.getElementType()) {
