 ...
 * @generated
 */
public class PipenetDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.PipenetDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									Messages.PipenetDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = PipenetDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor.beginTask(
				Messages.PipenetDiagramEditorUtil_CreateDiagramProgressTask, 3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				Messages.PipenetDiagramEditorUtil_CreateDiagramCommandLabel,
				Collections.EMPTY_LIST) {
			protected CommandResult doExecuteWithResult(
					IProgressMonitor monitor, IAdaptable info)
					throws ExecutionException {
				Pipenet model = createInitialModel();
				...
				try {
					modelResource
							.save(pipenet.diagram.part.PipenetDiagramEditorUtil
									.getSaveOptions());
					diagramResource
							.save(pipenet.diagram.part.PipenetDiagramEditorUtil
									.getSaveOptions());
	 ...
	 * @generated
	 */
	private static Pipenet createInitialModel() {
		return PipenetFactory.eINSTANCE.createPipenet();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(Pipenet model, Resource resource) {
