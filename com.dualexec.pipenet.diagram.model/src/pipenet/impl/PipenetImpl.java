...
public class PipenetImpl extends MinimalEObjectImpl.Container implements Pipenet {
	...
	public EList<Node> getNodes() {
		if (nodes == null) {
			nodes = new EObjectResolvingEList<Node>(Node.class, this, PipenetPackage.PIPENET__NODES);
		}
		return nodes;
	}
	...
	public EList<Arc> getArcs() {
		if (arcs == null) {
			arcs = new EObjectResolvingEList<Arc>(Arc.class, this, PipenetPackage.PIPENET__ARCS);
		}
		return arcs;
	}
