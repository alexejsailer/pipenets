...
import pipenet.diagram.parsers.MessageFormatParser;
import pipenet.diagram.part.PipenetVisualIDRegistry;

/**
 * @generated
 */
public class PipenetParserProvider extends AbstractProvider implements
		IParserProvider {
	...
	private IParser getTransitionName_5001Parser() {
		if (transitionName_5001Parser == null) {
			EAttribute[] features = new EAttribute[] { PipenetPackage.eINSTANCE
					.getNode_Name() };
			EAttribute[] editableFeatures = new EAttribute[] { PipenetPackage.eINSTANCE
					.getNode_Name() };
	...
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(PipenetVisualIDRegistry.getVisualID(vid));
		}
		View view = (View) hint.getAdapter(View.class);
		if (view != null) {
			return getParser(PipenetVisualIDRegistry.getVisualID(view));
		}
		return null;
	}
	...
	public boolean provides(IOperation operation) {
		if (operation instanceof GetParserOperation) {
			...
			if (PipenetElementTypes.getElement(hint) == null) {
				return false;
			}
