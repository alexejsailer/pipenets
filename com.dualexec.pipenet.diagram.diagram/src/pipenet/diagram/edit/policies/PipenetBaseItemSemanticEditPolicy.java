 ...
 * @generated
 */
public class PipenetBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected PipenetBaseItemSemanticEditPolicy(IElementType elementType) {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						PipenetVisualIDRegistry.getVisualID((View) view));
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = PipenetElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = PipenetDiagramEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
			PipenetDiagramEditorPlugin.getInstance().setLinkConstraints(
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public boolean canCreateArc_4001(Pipenet container, Node source,
				Node target) {
